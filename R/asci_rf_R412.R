...
#### Results .csv ####
# Export results.
write_csv(ca_predictions2, "data_model_outputs/asci_rf_results_R4.1.2.csv")
...
write_csv(ca_sum, "data_model_outputs/asci_rf_results_summary_R4.1.2.csv")
...
# Create finalized training dataset and include all possible variables. 
qrf_dat <- mydf2_train %>%
  select(asci, AgKffactWs,	CBNFWs,	DamDensWs,	FertWs,	NABD_DensWs,	PctAgWs,	PctAgWsRp100,	PctImp2011Cat,	PctImp2011CatRp100,	PctImp2011Ws,	PctImp2011WsRp100,	PctUrbCat,	PctUrbCatRp100,	PctUrbWs,	PctUrbWsRp100,	RdCrsWs,	RdDensCat,	RdDensCatRp100,	RdDensWs,	RdDensWsRp100) 
...
write_csv(asci_lms,"data_model_outputs/asci_lms_R4.1.2.csv" )
...
# Export data
write_csv(process_summary, "data_model_outputs/asci_process_summary_R4.1.2.csv")
...
# png(file="L:/RipRAM_ES/Data/Working/healthy_watershed_random_forest/Results using published thresholds/asci_modeled_CA_Theroux_R4.1.2.png", units="in", width=8, height=5, res=300)
# modeled_asci_map
# dev.off()
