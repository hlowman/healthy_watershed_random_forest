...
#### Results .csv ####
# Export results.
write_csv(ca_predictions2, "data_model_outputs/crambio_rf_results_R4.1.2.csv")
...
write_csv(ca_sum, "data_model_outputs/crambio_rf_results_summary_R4.1.2.csv")
...
write_csv(bioticstructure_lms, "data_model_outputs/crambio_lms_R4.1.2.csv" )
...
# Export data
write_csv(process_summary, "data_model_outputs/crambio_process_summary_R4.1.2.csv")
...
# png(file="L:/RipRAM_ES/Data/Working/healthy_watershed_random_forest/Results using published thresholds/bioticstructure_modeled_CA_81ref_R4.1.2.png", units="in", width=8, height=5, res=300)
# modeled_cram_map
# dev.off()
